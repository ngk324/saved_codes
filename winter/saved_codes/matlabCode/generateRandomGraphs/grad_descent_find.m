function [w] = grad_descent_find(G_init,prob,num)
    %% Some parameters
    ...
    fileB = strcat('results/weights_final/', num2str(num),'/L_init-',num2str(num),'.txt');
    ...
    fileB = strcat('results/weights_final/',num2str(num),'/ObjBefore.txt');
    fidResultB = fopen(fileB, 'a' );
    ...
    fileA = strcat('results/weights_final/ObjAfter.txt');
    ...
    fileA = strcat('results/weights_final/',num2str(num),'/ObjAfter.txt');
    fidResultA = fopen(fileA, 'a' );
   ...
   % [A_final,D_final,L_final] = generateMatricesFromWeights(G_init);
    ...
    % form is probFraction-graphNum
    fileB = strcat('results/weights_final/',num2str(num),'/L_Final-',num2str(num),'.txt');
