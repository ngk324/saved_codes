...
def getcross_validation_split(dataset_path='~/Dataset/MUTAG', dataset_name='MUTAG', n_folds=2, batch_size=1):

    dataset = TUDataset(root=dataset_path, name=dataset_name, pre_transform=get_graph_diameter)
